...
class Connection {
     ...
     * Constructor.
     */
    constructor(connection, request, document, timeout, socketId, context, readOnly = false) {
     ...
     */
    send(message) {
        if (this.webSocket.readyState === exports.WsReadyStates.Closing
            || this.webSocket.readyState === exports.WsReadyStates.Closed) {
            this.close();
        }
        try {
...
var license = "MIT";
var type = "module";
var main = "dist/hocuspocus-server.esm.js";
...
class Hocuspocus {
    ...
    showStartScreen() {
        ...
        console.log();
        console.log(`  > HTTP: ${kleur__default["default"].cyan(`http://127.0.0.1:${this.configuration.port}`)}`);
    ...
    createConnection(connection, request, document, socketId, readOnly = false, context) {
        ...
        if (connection.readyState === exports.WsReadyStates.Closing
            || connection.readyState === exports.WsReadyStates.Closed) {
            instance.close();
        }
        return instance;
    }
