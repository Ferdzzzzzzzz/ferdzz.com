...
import {SessionType, TDShapeType} from '~/components/canvasCopy/types'
import {BaseTool} from '../BaseTool'
import Vec from '@tldraw/vec'
import {TLDR} from '~/components/canvasCopy/state/TLDR'
import {CLONING_DISTANCE, DEAD_ZONE} from '~/components/canvasCopy/constants'
