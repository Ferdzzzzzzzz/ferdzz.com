...
import {EASINGS} from '~/components/canvasCopy/constants'
import {getShapeStyle} from '~/components/canvasCopy/state/shapes/shared'
import type {Decoration, ShapeStyles} from '~/components/canvasCopy/types'
import {
  getArcLength,
  getArrowArcPath,
  getCtp,
