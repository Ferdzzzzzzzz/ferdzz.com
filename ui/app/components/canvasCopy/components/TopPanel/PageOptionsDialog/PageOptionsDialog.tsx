...
import type {TDSnapshot, TDPage} from '~/components/canvasCopy/types'
import {useTldrawApp} from '~/components/canvasCopy/hooks'
import {
  RowButton,
  RowButtonProps,
} from '~/components/canvasCopy/components/Primitives/RowButton'
import {styled} from '~/components/canvasCopy/styles'
import {Divider} from '~/components/canvasCopy/components/Primitives/Divider'
import {IconButton} from '~/components/canvasCopy/components/Primitives/IconButton/IconButton'
import {SmallIcon} from '~/components/canvasCopy/components/Primitives/SmallIcon'
import {breakpoints} from '~/components/canvasCopy/components/breakpoints'
...
export function PageOptionsDialog({
  ...
  onOpen,
  onClose,
}: PageOptionsDialogProps): JSX.Element {
